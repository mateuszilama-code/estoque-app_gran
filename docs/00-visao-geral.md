...
- **Etapa 5:** módulo de Produto — entity (sequelize-typescript), DTOs com validação e
  `@ApiProperty`, service com regra de **código de barras único** e CRUD documentado na Swagger UI.

...
/**
 * Card — superfície padrão do dashboard.
 * Ajustes em relação ao preset do shadcn/ui: raio vindo do token (`rounded-lg`
 * = 12px), sombra única `shadow-card` e padding de 20px (densidade alta).
 */
